...
<html>
    ...
    <body style="background-color: #e7e7e7">
        <br>
        <div class="container">
            <form method="post" action="${pageContext.servletContext.contextPath}/materia/deletar">
            ...
            <a class="btn btn-primary" href="${pageContext.servletContext.contextPath}/materia/listar">Voltar</a>
        </div>
    </body>
</html>
